...
public class Return extends javax.swing.JFrame {
    ...
    public void returnUpdate(){
        String sql="insert into return(Student_ID,SName,Father,Course,Branch,Year,Sem,Book_ID,BName,Edition,Publisher,Price,Pages,DOI,DOR)"
                + "values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pt=con.prepareStatement(sql);
            pt.setString(1,jTextField1.getText());
            ...
            pt.setString(14,jTextField14.getText());
            pt.setString(15,((JTextField)jDateChooser1.getDateEditor().getUiComponent()).getText());
            pt.execute();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 2, true), "Return Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(8, 205, 8))); // NOI18N
        ...
        setSize(new java.awt.Dimension(911, 548));
